...
:--- | ---: | ---:
Kernel, dtbs, modules and GIC stub | 5.4.59.20200825 | [bcm2711-kernel-5.4.59.20200825.tar.xz](https://github.com/sakaki-/bcm2711-kernel/releases/download/5.4.59.20200825/bcm2711-kernel-5.4.59.20200825.tar.xz)
...
```console
linuxpc ~ # wget -cO- https://github.com/sakaki-/bcm2711-kernel/releases/download/5.4.59.20200825/bcm2711-kernel-5.4.59.20200825.tar.xz | tar -xJf- -C /mnt/piroot/
```
