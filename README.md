...
:--- | ---: | ---:
Kernel, dtbs, modules and GIC stub | 5.4.49.20200630 | [bcm2711-kernel-5.4.49.20200630.tar.xz](https://github.com/sakaki-/bcm2711-kernel/releases/download/5.4.49.20200630/bcm2711-kernel-5.4.49.20200630.tar.xz)
...
```console
linuxpc ~ # wget -cO- https://github.com/sakaki-/bcm2711-kernel/releases/download/5.4.49.20200630/bcm2711-kernel-5.4.49.20200630.tar.xz | tar -xJf- -C /mnt/piroot/
```
