...
:--- | ---: | ---:
Kernel, dtbs, modules and GIC stub | 5.4.51.20200721 | [bcm2711-kernel-5.4.51.20200721.tar.xz](https://github.com/sakaki-/bcm2711-kernel/releases/download/5.4.51.20200721/bcm2711-kernel-5.4.51.20200721.tar.xz)
...
```console
linuxpc ~ # wget -cO- https://github.com/sakaki-/bcm2711-kernel/releases/download/5.4.51.20200721/bcm2711-kernel-5.4.51.20200721.tar.xz | tar -xJf- -C /mnt/piroot/
```
