...
:--- | ---: | ---:
Kernel, dtbs, modules and GIC stub | 4.19.59.20190724 | [bcm2711-kernel-4.19.59.20190724.tar.xz](https://github.com/sakaki-/bcm2711-kernel/releases/download/4.19.59.20190724/bcm2711-kernel-4.19.59.20190724.tar.xz)
...
```console
pi64 ~ # wget -c https://github.com/sakaki-/bcm2711-kernel/releases/download/4.19.59.20190724/bcm2711-kernel-4.19.59.20190724.tar.xz
